...
- [ ] 1. Update visualization-guide.md with Visualization Prompt and expanded Web Server Guidance
  - [ ] 1.1 Add Visualization Prompt as the first step in the Agent Workflow
  ...
  - [ ] 1.2 Expand the Web Server Guidance section with full endpoint specifications
  ...
  - [ ] 1.3 Add framework selection table and code generation instructions
  ...
  - [ ] 1.4 Add lifecycle management instructions to visualization-guide.md
  ...
  - [ ] 1.5 Add feature parity and additional web service features documentation
...
- [ ] 2. Update module-03-quick-demo.md with Visualization Prompt
  - [ ] 2.1 Add Visualization Prompt to Phase 2 Step 5
...
- [ ] 3. Update module-08-query-validation.md with Visualization Prompt
  - [ ] 3.1 Add Visualization Prompt to the entity graph offer section
  ...
  - [ ] 3.2 Add Visualization Prompt to the results dashboard offer section
...
- [ ] 4. Write structural validation tests
  - [ ] 4.1 Write tests for visualization-guide.md Visualization Prompt and branching
  ...
  - [ ] 4.2 Write tests for visualization-guide.md Web Server Guidance endpoints
  ...
  - [ ] 4.3 Write tests for visualization-guide.md code generation and lifecycle
  ...
  - [ ] 4.4 Write tests for visualization-guide.md feature parity
  ...
  - [ ] 4.5 Write tests for module-03-quick-demo.md Visualization Prompt
    - Verify the Visualization Prompt appears in Phase 2 Step 5
    - Verify the prompt offers both static HTML and web service options
    - Verify a WAIT instruction follows the prompt
    - _Requirements: 5.2_

  - [ ] 4.6 Write tests for module-08-query-validation.md Visualization Prompt
