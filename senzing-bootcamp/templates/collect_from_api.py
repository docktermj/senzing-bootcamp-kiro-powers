...
Usage:
    python collect_from_api.py --url "https://api.example.com/customers" --output data/raw/customers.json
    python collect_from_api.py --url "https://api.example.com/customers" --output data/raw/customers.json --auth-token "your_token"
"""
