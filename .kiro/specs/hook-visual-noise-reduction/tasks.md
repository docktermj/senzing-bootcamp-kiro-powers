...
- [ ] 1. Consolidate agentStop hooks into ask-bootcamper.kiro.hook
  - [ ] 1.1 Build the consolidated ask-bootcamper.kiro.hook (v4.0.0) with four-phase prompt
  ...
  - [ ]* 1.2 Write property test for consolidated hook phase markers (Property 1)
  ...
  - [ ]* 1.3 Write property test for consolidated hook structural validity (Property 2)
  ...
  - [ ]* 1.4 Write property test for step sequencing and MCP-first logic preservation (Property 3)
  ...
  - [ ]* 1.5 Write property test for question format detection patterns with silent self-correction (Property 4)
  ...
  - [ ]* 1.6 Write property test for silent self-correction instructs regeneration (Property 5)
  ...
  - [ ]* 1.7 Write property test for non-compound case produces no phase output (Property 6)
...
- [ ] 2. Strengthen write-policy-gate silence directives
  - [ ] 2.1 Update write-policy-gate.kiro.hook prompt with reinforced silence directives
  ...
  - [ ]* 2.2 Write property test for write-policy-gate dual-reinforcement suppression (Property 8)
...
- [ ] 3. Checkpoint - Verify core hook changes
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 4. Delete obsolete hook files and update registries
  - [ ] 4.1 Delete the three obsolete hook files
  ...
  - [ ] 4.2 Update hook-categories.yaml to remove deleted hooks
  ...
  - [ ] 4.3 Update hooks.lock.yaml to remove deleted hooks and bump ask-bootcamper version
  ...
  - [ ]* 4.4 Write property test for deleted hooks absent from categories file (Property 7)
...
- [ ] 5. Update steering and documentation references
  - [ ] 5.1 Update hook-registry-critical.md steering file
  ...
  - [ ] 5.2 Update hook-registry.md steering file
    - Remove rows for deleted hooks from the quick-reference table
    - _Requirements: 7.3_

  - [ ] 5.3 Update hooks/README.md documentation
    - Remove entries for deleted hooks
    - _Requirements: 7.4_

  - [ ] 5.4 Update POWER.md hook references
    - Remove references to deleted hooks and adjust the hook count
    - _Requirements: 7.5_

- [ ] 6. Migrate tests to validate consolidated hook
  - [ ] 6.1 Update test_mcp_first_invariant_properties.py to point at consolidated hook
  ...
  - [ ] 6.2 Update test_single_question_format.py to point at consolidated hook
  ...
  - [ ] 6.3 Update test_detect_transition_retry.py to point at consolidated hook
    - Change `_HOOK_FILE` path to `ask-bootcamper.kiro.hook`
    - _Requirements: 8.3_

  - [ ] 6.4 Update hook_test_helpers.py CRITICAL_HOOKS list
