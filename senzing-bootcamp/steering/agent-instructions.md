...
- **Data visualization:** When presenting data results to the bootcamper (entity resolution results, quality analysis, match explanations, statistics), ask: "Would you like me to visualize this data as a web page?" If yes, ask what interactive features they'd like: "Would you like support for any of these? (a) Real-time entity queries, (b) 'how' entity explanations showing how an entity resolved, (c) 'why' match analysis showing why two records matched, (d) search by attributes, (e) find paths/networks between entities." Generate accordingly — use the SDK's query capabilities (`how_entity_by_entity_id`, `why_entity_by_entity_id`, `search_by_attributes`, `find_path_by_entity_id`) to power interactive features. Save to `docs/` or `data/temp/`.
