...
def main():
    ...
    parser.add_argument('--frequency', choices=['static', 'daily', 'realtime'], help='Update frequency')
    parser.add_argument('--deployment', choices=['cloud', 'on-premise'], default='cloud')
    parser.add_argument('--performance', choices=['standard', 'high', 'premium'], default='standard')
