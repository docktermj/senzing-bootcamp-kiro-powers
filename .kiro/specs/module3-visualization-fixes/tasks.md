...
- [x] 1. Add enforcement block to steering file
  - [x] 1.1 Insert the "DO NOT SKIP" enforcement block after the CRITICAL LESSONS section and before Step 9
...
- [x] 2. Fix Entity Graph viewport height
  - [x] 2.1 Replace fixed pixel height with viewport-relative height in the Entity Graph section
...
- [x] 3. Add post-launch guided tour
  - [x] 3.1 Insert guided tour instructions in section 9.4 after URL presentation and before the STOP block
...
- [x] 4. Checkpoint - Verify steering file edits
  - Ensure all tests pass, ask the user if questions arise.

- [x] 5. Write property-based tests
  - [x] 5.1 Write property test for enforcement block completeness
  ...
  - [x] 5.2 Write property test for graph container viewport-relative height
  ...
  - [x] 5.3 Write property test for guided tour content completeness
  ...
  - [x] 5.4 Write property test for guided tour structural ordering
...
- [x] 6. Write unit tests
  - [x] 6.1 Write unit tests for viewport height and guided tour placement
