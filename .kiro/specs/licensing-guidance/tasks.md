...
- [ ] 1. Modify steering file to add MCP license guidance
  - [ ] 1.1 Add MCP license guidance paragraph to sub-step 5a
  ...
  - [ ] 1.2 Add MCP license guidance sentence to sub-step 5c "no license" path
...
- [ ] 2. Verify structural test compliance
  - [ ] 2.1 Run existing property-based test suite against modified file
...
- [ ] 3. Checkpoint - Ensure structural tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 4. Create example-based tests for licensing guidance content
  - [ ] 4.1 Create test file `senzing-bootcamp/tests/test_licensing_guidance.py`
  ...
  - [ ] 4.2 Implement tests for sub-step 5a MCP guidance
  ...
  - [ ] 4.3 Implement tests for sub-step 5c "no license" MCP guidance
  ...
  - [ ] 4.4 Implement scope and accuracy tests
