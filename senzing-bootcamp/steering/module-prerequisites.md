...
| 6 — Single Source Load       | Module 2 + Module 5, transformed data in `data/transformed/` | Data already loaded → Module 8                   |
| 7 — Multi-Source             | Module 6                                                     | Single data source → Module 8                    |
| 8 — Query & Visualize         | Module 6 or 7, no critical load errors                       | Already validated → Module 9                     |
