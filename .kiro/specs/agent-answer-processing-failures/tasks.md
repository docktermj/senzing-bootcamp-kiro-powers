...
- [x] 1. Update steering files with answer-processing priority directives
  - [x] 1.1 Add Answer Processing Priority section to `agent-instructions.md`
  ...
  - [x] 1.2 Add Answer Processing Priority section to `conversation-protocol.md`
...
- [x] 2. Restructure hook Phase 2 and add Phase 3
  - [x] 2.1 Broaden Phase 2 from MODULE TRANSITION RETRY to ANSWER PROCESSING RETRY
  ...
  - [x] 2.2 Add Phase 3: Not-Waiting Detection to the hook
  ...
  - [x] 2.3 Update hook `description` field to reflect broadened scope
...
- [x] 4. Update Question_Pending file schema documentation in steering
  - [x] 4.1 Update End-of-Turn Protocol in `conversation-protocol.md` with structured schema
  ...
  - [x] 4.2 Update `agent-instructions.md` Question Stop Protocol with structured schema
...
- [x] 5. Implement question_pending schema utilities and tests
  - [x] 5.1 Create `senzing-bootcamp/tests/test_answer_processing_failures_properties.py`
  ...
  - [x] 5.2 Write property test for Question_Pending round-trip
    - **Property 3: Question_Pending File Round-Trip**
    - **Validates: Requirements 5.1, 5.2, 5.3**

  - [x] 5.3 Write property test for Phase 2 activation broadening
    - **Property 1: Phase 2 Activation Broadening**
    - **Validates: Requirements 3.1, 3.3, 3.4**

  - [x] 5.4 Write property test for type-specific retry instruction completeness
    - **Property 2: Type-Specific Retry Instruction Completeness**
    - **Validates: Requirements 4.1, 4.2, 4.3, 4.4, 4.5, 4.6**

- [x] 6. Create repo-level hook prompt validation tests
  - [x] 6.1 Create `tests/test_answer_processing_hook_prompt.py`
  ...
  - [x] 6.2 Write property test for Minimal_Output classification
...
- [x] 7. Create steering file content validation tests
  - [x] 7.1 Create `tests/test_answer_processing_steering.py`
