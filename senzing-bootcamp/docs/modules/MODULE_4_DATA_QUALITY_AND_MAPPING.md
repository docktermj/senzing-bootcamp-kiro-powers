...
After collecting data sources in Module 3, you need to assess their quality before mapping. Phase 1 provides:
...
- **Proceed to Module 0:** Set Up Senzing SDK (if not already done)
- **Or proceed to Module 5:** Single Source Loading (if SDK already installed)

## Related Documentation

- `POWER.md` - Bootcamp overview
- `steering/module-04-data-quality-mapping.md` - Module 4 workflow
...
- **v4.0.0** (2026-04-17): Merged Module 4 (Data Quality Scoring) and Module 5 (Data Mapping) into unified module
- **v3.0.0** (2026-03-17): Original Module 4 (quality scoring) and Module 5 (data mapping) created separately
