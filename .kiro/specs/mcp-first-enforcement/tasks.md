...
- [x] 1. Modify the steering file to enforce MCP-first principle
  - [x] 1.1 Rewrite Step 3 to replace hardcoded attributes with download_resource instruction
  ...
  - [x] 1.2 Rewrite Step 4 to remove hardcoded attribute mapping examples
  ...
  - [x] 1.3 Rewrite Step 5 to remove hardcoded attribute references
...
- [x] 2. Checkpoint - Verify steering file changes
  - Ensure all tests pass, ask the user if questions arise.

- [x] 3. Implement property-based tests for the modified steering file
  - [x] 3.1 Create test helper for step extraction and attribute detection
  ...
  - [x] 3.2 Write property test: No hardcoded Entity Specification attributes in Steps 3–5
  ...
  - [x] 3.3 Write property test: Exactly one download_resource instruction
  ...
  - [x] 3.4 Write property test: download_resource placement precedes Entity Specification references
