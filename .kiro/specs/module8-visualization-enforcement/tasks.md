...
- [ ] 1. Update steering file with mandatory WAIT blocks
  - [ ] 1.1 Insert entity graph MANDATORY WAIT block into `senzing-bootcamp/steering/module-08-query-validation.md`
  ...
  - [ ] 1.2 Insert results dashboard MANDATORY WAIT block into `senzing-bootcamp/steering/module-08-query-validation.md`
...
- [ ] 2. Create the visualization enforcement hook
  - [ ] 2.1 Create `senzing-bootcamp/hooks/enforce-visualization-offers.kiro.hook`
  ...
  - [ ]* 2.2 Write property test for hook JSON schema conformance
...
- [ ] 3. Checkpoint — Verify steering file and hook
...
- [ ] 4. Update hooks README
  - [ ] 4.1 Update entry #14 in `senzing-bootcamp/hooks/README.md`
  ...
  - [ ] 4.2 Add entry #17 to `senzing-bootcamp/hooks/README.md`
  ...
  - [ ]* 4.3 Write property test for README hook entry format conformance
...
- [ ] 5. Final checkpoint — Validate all deliverables
