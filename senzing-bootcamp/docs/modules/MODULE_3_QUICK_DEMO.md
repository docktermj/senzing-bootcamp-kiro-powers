...
> **Agent workflow:** The agent follows `steering/module-03-quick-demo.md` for this module's step-by-step workflow.

## Overview

Module 3 provides a demonstration of Senzing entity resolution using sample data. This optional module is perfect for first-time users who want to see entity resolution in action before working with their own data.
...
- ✅ Module 2 complete (Senzing SDK installed)
...
3. Verify Senzing SDK is available (installed in Module 2)
...
1. **Verify Senzing SDK** - Confirms SDK is installed from Module 2 (SDK Setup)
...
All Module 3 demo code is saved in `src/quickstart_demo/`:
...
The demo runs automatically when you start Module 3 (Quick Demo). The agent will:

1. Verify Senzing SDK is installed (from Module 2 SDK Setup)
...
A: Yes. Complete Module 2 (SDK Setup) first.
...
A: The demo uses sample data to ensure a quick, successful experience. You'll work with your data starting in Module 4.
...
1. **Complete Module 2 first** (SDK Setup)
   - Module 2 installs the SDK natively
   - Return to Module 3 after installation

2. **Verify SDK installation**

   Verify the SDK is installed for your chosen language using the checks from Module 2.
...
### Issue: Module 3 Taking Longer Than Expected
...
2. **Skip to Module 1**
   ...
   - Return to Module 2 and 3 later when setup is resolved
...
**Before starting Module 3, verify your environment**:
...
✅ Senzing SDK is installed and working (from Module 2)
...
- `steering/module-03-quick-demo.md` - Module 3 workflow
- `QUICK_START.md` - Quick start guide

## Version History

- **v3.0.0** (2026-03-17): Module 3 documentation created
