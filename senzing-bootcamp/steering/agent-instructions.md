...
- **Input-required marker:** When asking the bootcamper a question that requires their input, prefix it with **"👉"** so they can clearly see when a response is needed vs. when you're just providing information. Example: "👉 Which language would you like to use?" vs. "I've created the project directory structure." This helps bootcampers who have trouble distinguishing informational messages from questions.
