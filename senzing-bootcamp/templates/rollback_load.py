...
Usage:
    python rollback_load.py --data-source CUSTOMERS --config-json '{"SQL":{"CONNECTION":"sqlite3://na:na@database/G2C.db"}}'
"""
...
def rollback_load(data_source: str, engine_config: str, confirm: bool = True) -> bool:
    ...
    if confirm:
        response = input(f"⚠️  This will delete ALL records from {data_source}. Continue? (yes/no): ")
