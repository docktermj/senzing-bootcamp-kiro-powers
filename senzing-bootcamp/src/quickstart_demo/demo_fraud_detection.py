...
def run_demo(config_json):
    ...
    try:
        ...
        response = bytearray()
        g2_engine.getEntityByRecordID("CLAIMS", "CLAIM-1001", response, G2Engine.G2_ENTITY_INCLUDE_RELATED_ENTITY_DETAILS)
        ...
        print(f"Fraud Ring Entity IDs: {entity_id}, {[r.get('ENTITY_ID') for r in related_entities]}")
