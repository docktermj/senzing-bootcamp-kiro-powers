...
- [ ] 1. Add the `substantive_response` Assertion_Type to the harness
  - [ ] 1.1 Implement and register the `_substantive_response` predicate
...
- [ ] 2. Author the four positive-exemplar Scenario_Fixtures
  - [ ] 2.1 Add `mcp_first_sdk_reference.json` (MCP-First SDK / attribute branch)
  ...
  - [ ] 2.2 Add `sql_redirect_reporting_guide.json` (no-direct-SQL redirect)
  ...
  - [ ] 2.3 Add `confirmation_question_disambiguation.json` (👉 disambiguation)
  ...
  - [ ] 2.4 Add `substantive_response_after_confirmation.json` (substantive response after a Transition_Confirmation)
...
- [ ] 3. Extend the harness test suite
  - [ ] 3.1 Write the property test for `substantive_response`
  ...
  - [ ] 3.2 Write the fixture-pass test class for the four new fixtures
  ...
  - [ ] 3.3 Update the shipped-fixture oracle constant
...
- [ ] 4. Checkpoint — verify the expanded harness and CI gates
