...
- [x] 1. Create the phase gate hook file
  ...
  - [x] 1.2 Write property test for hook JSON schema conformance
...
- [x] 2. Update the steering file with phase gate section
...
- [x] 3. Checkpoint — Verify hook and steering file
...
- [x] 4. Update hooks README with new entry
  ...
  - [x] 4.2 Write property test for README hook entry format conformance
