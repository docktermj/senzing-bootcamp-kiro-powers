...
| module-recap-append | any | agentStop → askAgent | Appends a structured recap section to docs/bootcamp_recap.md when a module is completed, then verifies the section persisted and backfills it if absent. |
