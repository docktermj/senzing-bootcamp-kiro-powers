...
> **User reference:** `docs/modules/MODULE_3_QUICK_DEMO.md`
...
2. **Verify SDK** from Module 2. If not found → direct to Module 2 first.
...
6. **Close Module 3 explicitly.** Before asking any use-case questions, mark the module as done and state its purpose:
   ...
   "That's Module 3 complete! The purpose of this demo was to verify that your entire system works end-to-end — SDK, database, data loading, and entity resolution. The sample data and results were just a test, not the real work."
...
7. **Transition to Module 1.** Only after Module 3 is closed, introduce Module 1 with a clear contrast:

   "Starting with Module 1, we shift to YOUR use case — your data, your problem, your success criteria. This is where the real work begins."
   ...
   Do NOT ask record-type, source-count, or duplicate-definition questions here. Module 1 will handle discovery through its open-ended prompt.
