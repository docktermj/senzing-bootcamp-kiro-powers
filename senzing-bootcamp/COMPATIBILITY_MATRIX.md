...
| Feature | Senzing 3.x | Senzing 4.0 | Notes |
|---------|-------------|-------------|-------|
...
| Platform | Senzing 3.x | Senzing 4.0 | Recommended |
|----------|-------------|-------------|-------------|
| **Ubuntu 20.04** | ✅ | ✅ | ✅ |
| **Ubuntu 22.04** | ✅ | ✅ | ✅ |
| **RHEL 8** | ✅ | ✅ | ✅ |
...
| **senzing** | 3.0.0 | 4.0.0+ | Latest stable |
...
**Compatibility Mode**:
- V4 can read V3 databases
- Gradual migration supported
- No data loss

## Boot Camp Module Compatibility

| Module | V3.x | V4.0 | Notes |
|--------|------|------|-------|
