...
- Verify the file passed linting (Module 5)
...
- Do entity counts align with expectations from the business problem (Module 1)?

This is a lighter validation than the full cross-source UAT in Module 7. The goal is to catch obvious issues before adding more sources.
...
- **To Module 8:** Loaded data is queried and visualized
- **Validation:** Single-source validation (match accuracy, false positive/negative review) is performed here as the final phase of loading, before proceeding to Module 7 or 8
